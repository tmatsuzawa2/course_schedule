...
class CheckedNoSub extends React.Component {
  constructor(props) {
    super(props);
  ...
  handleChange(event) {
    ...
    if (this.state.checkboxChecked === false) {
      this.props.pushSec([this.props.sec, this.props.data, this.updated]);
      this.props.setClass();
    }
    else 
      this.props.pushSec([this.props.sec, {}, this.updated]);
      this.props.setClass();
  ...
  handleLock() {
    if (this.state.lock === true) {
      ...
      this.props.pushSec([this.props.sec, this.props.data, true]);
      this.props.setClass();
    } else {
      if (this.state.checkboxChecked === false) {
      ...
      if (this.props.locked === true) {
        ...
        this.props.pushLock([this.props.sec, this.props.data, true]);
      }
    }
  }
  ...
  render() {
    return (
      <>
        ...
        <Form.Group>
          <Form.Row>
            <Form.Check type="checkbox" label={`${this.props.sec}`} checked={this.currCheck()} onChange={this.handleChange}/>
